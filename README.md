...
一个独立的 Minecraft: Java Edition 启动器项目，当前处于功能预览阶段。

**非官方 Minecraft 启动器。未经 Mojang 或 Microsoft 认可，亦与其无关联。**

**NOT AN OFFICIAL MINECRAFT LAUNCHER. NOT APPROVED BY OR ASSOCIATED WITH MOJANG OR MICROSOFT.**

目前支持原版版本获取与安装、离线启动、导入现有 `.minecraft` 目录，以及部分 Fabric 实例修复。微软网页登录流程已实现，应用 ID 已提交 Minecraft AppID Review 审核，但尚未获批；当前正版登录会在服务端返回 `Invalid app registration`。请勿将本仓库视为已完成正版登录的正式发行版。
